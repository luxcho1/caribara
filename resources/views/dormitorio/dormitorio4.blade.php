...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-4">
      <img src="/images/dormitorio4.jpg" class="product-image" alt="Product Image">
    </div>
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Cama Liberty</h5>
          <p class="card-text">La cama "Liberty" para niñas pequeñas combina encanto y funcionalidad, creando un espacio acogedor y seguro para el descanso de tu hija. Su diseño encantador y colores suaves aportan un toque de dulzura y elegancia al dormitorio infantil
          </p>
          <p><strong>Precio:</strong> <span class="price">$100.000</span></p>
          <p><strong>Medidas:</strong> 200cm x 100cm x 30cm</p>
          <p><strong>Stock Disponible:</strong> 30</p>
