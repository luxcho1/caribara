...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-4">
      <img src="/images/dormitorio2.jpg" class="product-image" alt="Product Image">
    </div>
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Respaldo Garcia</h5>
          <p class="card-text">Ideal para cualquier dormitorio o sala de estar, el velador "García" combina estética y funcionalidad, proporcionando un toque de calidez y elegancia a tu hogar. Fácil de ensamblar y mantener, es una excelente adición a cualquier espacio</p>
          <p><strong>Precio:</strong> <span class="price">$55.000</span></p>
          <p><strong>Medidas:</strong> 50cm x 50cm x 100cm</p>
          <p><strong>Stock Disponible:</strong> 40</p>
          <p><strong>Materiales:</strong> 3 Planchas, 10 Tornillos</p>
