...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-4">
      <img src="/images/dormitorio1.jpg" class="product-image" alt="Product Image">
    </div>
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Respaldo Garcia</h5>
          <p class="card-text">Respaldo de madera "García" fabricado en pino de alta calidad, con un diseño clásico y elegante que resalta las vetas naturales de la madera. Perfecto para cualquier estilo de decoración, es duradero y fácil de instalar.</p>
          <p><strong>Precio:</strong> <span class="price">$120.000</span></p>
          <p><strong>Medidas:</strong> 5cm x 200cm x 156cm</p>
